...
let paragraf = document.querySelectorAll('span');
document.addEventListener('click', (e) => {


        if(e.target == document.getElementById('respi')){
            respiracao.style.display = 'block';
        }

    if(e.target == respiracao){
   ...
   if (e.target == document.getElementById('constellation')){
    ...
    if(e.target == document.getElementById('increment') || (e.target == document.getElementById('ponto1')) || (e.target == document.getElementById('pontos2')) || 
  ...
  if(e.target == document.getElementById('força')){
    ...
    if(e.target == document.getElementById('increment') || (e.target == document.getElementById('ponto1')) || (e.target == document.getElementById('ponto2')) || (e.target == document.getElementById('pontos3')) ||(e.target == document.getElementById('pontos4')) || (e.target == document.getElementById('pontos5')) || (e.target == document.getElementById('pontos6'))|| (e.target == document.getElementById('pontos7'))|| (e.target == document.getElementById('pontos8'))){
        myFourthModal.style.display = 'block';
    }
    if(e.target == myFourthModal){
        myFourthModal.style.display = 'none';
